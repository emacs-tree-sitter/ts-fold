...
(defun ts-fold-parsers-python ()
  ...
  '((import_statement         . ts-fold-range-seq)
    ...
    (while_statement          . ts-fold-range-python-block)
    (for_statement            . ts-fold-range-python-block)
    (if_statement             . ts-fold-range-python-block)
    (elif_clause              . ts-fold-range-python-block)
    (else_clause              . ts-fold-range-python-block)
    (match_statement          . ts-fold-range-python-block)
    (case_clause              . ts-fold-range-python-block)
    (try_statement            . ts-fold-range-python-block)
    (except_clause            . ts-fold-range-python-block)
    (with_statement           . ts-fold-range-python-block)
    (list                     . ts-fold-range-seq)
    (dictionary               . ts-fold-range-seq)
    (parenthesized_expression . ts-fold-range-seq)
...
(defun ts-fold-parsers-ruby ()
  ...
  '((class            . ts-fold-range-ruby-class-def)
    (module           . ts-fold-range-ruby-class-def)
    (method           . ts-fold-range-ruby-class-def)
    (singleton_method . ts-fold-range-ruby-class-def)
    (array            . ts-fold-range-seq)
